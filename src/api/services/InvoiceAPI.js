    ...
    getNCFInvoicesByDates: function (_date1, _date2) {
        ...
        .then(response => {
            const dataList = response.data.data.map(invoice => ({
                ...
                ITBIS: (
                    Math.round((invoice.attributes.Total - invoice.attributes.Total / 1.18) * 100) /
                    100
        ...
        .then(response => {
            ...
            if(invoice !== undefined) {
                data = {
                    ...
                    searchClientParam: invoice.attributes.Customer.data !== null ? invoice.attributes.Customer.data.attributes.CustomerCode : "",
